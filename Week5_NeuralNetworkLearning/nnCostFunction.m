...
%Find error for last layer

delta_3 = (a_3 - y)';

size(delta_3)

%error for previous layers
g_prime = sigmoidGradient(z_2);

int = (Theta2(:, 2:end)' * delta_3);
...
% Simply create the regularization term
%adding all the terms of the theta matrices
